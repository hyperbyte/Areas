...
<div class="registration-page">
    <div class="page-title">
        <h1>
            <%=GetLocaleResourceString("Account.Registration")%></h1>
    </div>
    <div class="clear">
    </div>
    <div class="body">
        <asp:CreateUserWizard ID="CreateUserForm" EmailRegularExpression="[\w\.-]+(\+[\w-]*)?@([\w-]+\.)+[\w-]+"
            ...
            DuplicateEmailErrorMessage="<% $NopResources:Account.DuplicateEmail %>" DuplicateUserNameErrorMessage="<% $NopResources:Account.DuplicateUserName %>">
            <WizardSteps>
                                        ...
                                        <asp:PlaceHolder runat="server" ID="phVatNumber">
                                            <tr class="row">
                                                ...
                                                <td class="item-value">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvVatNumber" runat="server" ControlToValidate="txtVatNumber"
                                                        ErrorMessage="<% $NopResources:Account.VatNumberIsRequired %>" ToolTip="<% $NopResources:Account.VatNumberIsRequired %>"
                                                        ValidationGroup="CreateUserForm">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr class="row">
