...
<div class="block block-shoppingcart">
    <div class="title" style="white-space: nowrap;">
        <i class="fa fa-shopping-cart" aria-hidden="true" style="font-size: 2em; margin: 0 5px 0 0; color: #FFA500"></i><%=GetLocaleResourceString("MiniShoppingCartBox.Information")%>
    </div>
    <div class="clear">
    </div>
    <div class="listbox">
